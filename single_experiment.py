...
parser.add_argument('--mod_dataset', default='')
parser.add_argument('--device',default='cuda')
parser.add_argument('--num_gen_iter', type=int)
parser.add_argument('--num_dis_iter', type=int)
...
cls_train_steps = [
      {'dataset': 'SUN',  'num_shots': 0, 'generalized': True, 'cls_train_steps': 26},
      ...
      {'dataset': 'CUB',  'num_shots': 0, 'generalized': True, 'cls_train_steps': 36},
